...
function CapturePhoto({ hide, setImage }) {
  ...
  return <div className="absolute h-4/6 w-2/6 top-1/3 left-1/3 bg-gray-900 gap-3 rounded-lg p-2 flex justify-center items-center">
    <div className="flex flex-col gap-4 w-full items-center justify-center">
      <div className="pt-2 pr-2 cursor-pointer flex items-end justify-end" onClick={() => hide(false)}>
        <IoClose className="h-10 w-10 cursor-pointer"/>
      </div>
      <div className="glex justify-center">
